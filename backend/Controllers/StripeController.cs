...
namespace backend.Controllers
{
    ...
    public class StripeController : ControllerBase
    {
        ...
        public class SubscribeRequest
        {
            ...
            public string SuccessUrl { get; set; } = "https://agorasoftlanding.ngrok.app/admin/success";
            public string CancelUrl { get; set; } = "https://agorasoftlanding.ngrok.app/admin/error";
        }
